...
# ---------------- 썸네일 커버 (SVG, slug별) ----------------
COVERS = {
"aeo-geo-seo": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="248" cy="46" r="66" fill="#2B5CFF" opacity=".28"/><circle cx="70" cy="152" r="54" fill="#0BBF8C" opacity=".16"/><rect x="40" y="40" width="150" height="32" rx="16" fill="#fff"/><circle cx="60" cy="56" r="7.5" fill="none" stroke="#2B5CFF" stroke-width="3"/><line x1="65.5" y1="61.5" x2="71" y2="67" stroke="#2B5CFF" stroke-width="3" stroke-linecap="round"/><rect x="80" y="52" width="64" height="8" rx="4" fill="#C7D6FF"/><rect x="66" y="92" width="200" height="56" rx="14" fill="#fff"/><circle cx="88" cy="115" r="11" fill="#2B5CFF"/><text x="88" y="119" font-size="10" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">AI</text><rect x="108" y="107" width="140" height="8" rx="4" fill="#0A1930"/><rect x="108" y="123" width="98" height="7" rx="3.5" fill="#B9C2D4"/><path d="M262 86l4.5 11 11 4.5-11 4.5-4.5 11-4.5-11-11-4.5 11-4.5z" fill="#0BBF8C"/></svg>""",
"ai-pr-guide": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="256" cy="44" r="58" fill="#2B5CFF" opacity=".26"/><rect x="40" y="34" width="240" height="112" rx="16" fill="#fff"/><circle cx="64" cy="60" r="11" fill="#2B5CFF"/><text x="64" y="64" font-size="10" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">AI</text><rect x="84" y="54" width="130" height="8" rx="4" fill="#0A1930"/><rect x="84" y="68" width="86" height="6" rx="3" fill="#B9C2D4"/><rect x="60" y="90" width="200" height="17" rx="6" fill="#EAF1FF"/><circle cx="73" cy="98.5" r="6" fill="#2B5CFF"/><rect x="88" y="95.5" width="96" height="6" rx="3" fill="#8FA3D9"/><rect x="228" y="92.5" width="26" height="12" rx="6" fill="#0BBF8C"/><rect x="60" y="114" width="200" height="17" rx="6" fill="#EAF1FF"/><circle cx="73" cy="122.5" r="6" fill="#2B5CFF"/><rect x="88" y="119.5" width="74" height="6" rx="3" fill="#8FA3D9"/><rect x="228" y="116.5" width="26" height="12" rx="6" fill="#0BBF8C"/></svg>""",
"press-release-writing": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="252" cy="140" r="62" fill="#0BBF8C" opacity=".16"/><rect x="74" y="28" width="150" height="130" rx="10" fill="#fff"/><rect x="90" y="44" width="118" height="12" rx="3" fill="#0A1930"/><rect x="90" y="64" width="118" height="6" rx="3" fill="#C7D6FF"/><rect x="90" y="76" width="88" height="6" rx="3" fill="#DCE6F7"/><rect x="90" y="94" width="52" height="36" rx="4" fill="#EAF1FF"/><rect x="150" y="94" width="58" height="6" rx="3" fill="#DCE6F7"/><rect x="150" y="106" width="58" height="6" rx="3" fill="#DCE6F7"/><rect x="150" y="118" width="40" height="6" rx="3" fill="#DCE6F7"/><rect x="90" y="140" width="72" height="9" rx="4" fill="#2B5CFF"/><rect x="228" y="38" width="56" height="20" rx="10" fill="#2B5CFF"/><text x="256" y="52" font-size="10" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">PRESS</text></svg>""",
"advertorial-vs-press": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><rect x="40" y="40" width="104" height="100" rx="10" fill="#fff"/><rect x="56" y="56" width="72" height="8" rx="4" fill="#2B5CFF"/><rect x="56" y="72" width="72" height="6" rx="3" fill="#DCE6F7"/><rect x="56" y="84" width="54" height="6" rx="3" fill="#DCE6F7"/><rect x="56" y="112" width="48" height="9" rx="4" fill="#0BBF8C"/><rect x="176" y="40" width="104" height="100" rx="10" fill="#fff"/><rect x="192" y="56" width="72" height="8" rx="4" fill="#0BBF8C"/><rect x="192" y="72" width="72" height="6" rx="3" fill="#DCE6F7"/><rect x="192" y="84" width="54" height="6" rx="3" fill="#DCE6F7"/><rect x="192" y="112" width="48" height="9" rx="4" fill="#2B5CFF"/><circle cx="160" cy="90" r="18" fill="#101F3F"/><text x="160" y="95" font-size="12" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">VS</text></svg>""",
"exhibition-pr": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="252" cy="46" r="54" fill="#0BBF8C" opacity=".18"/><path d="M62 62 h136 l-12 -20 h-112 z" fill="#2B5CFF"/><rect x="70" y="62" width="120" height="66" rx="6" fill="#fff"/><rect x="88" y="80" width="84" height="11" rx="4" fill="#C7D6FF"/><rect x="88" y="98" width="58" height="8" rx="4" fill="#EAF1FF"/><line x1="58" y1="150" x2="262" y2="150" stroke="#fff" stroke-width="2" opacity=".55"/><circle cx="80" cy="150" r="6" fill="#fff"/><circle cx="160" cy="150" r="8" fill="#0BBF8C"/><circle cx="240" cy="150" r="6" fill="#fff"/></svg>""",
"export-pr-strategy": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="90" r="130" fill="#2B5CFF" opacity=".14"/><circle cx="130" cy="92" r="58" fill="none" stroke="#fff" stroke-width="2.5" opacity=".85"/><ellipse cx="130" cy="92" rx="58" ry="22" fill="none" stroke="#fff" stroke-width="1.6" opacity=".5"/><ellipse cx="130" cy="92" rx="24" ry="58" fill="none" stroke="#fff" stroke-width="1.6" opacity=".5"/><line x1="72" y1="92" x2="188" y2="92" stroke="#fff" stroke-width="1.6" opacity=".5"/><circle cx="104" cy="66" r="5" fill="#0BBF8C"/><circle cx="158" cy="78" r="5" fill="#0BBF8C"/><circle cx="120" cy="120" r="5" fill="#0BBF8C"/><circle cx="236" cy="46" r="6" fill="#fff"/><path d="M158 78 Q210 40 236 46" stroke="#fff" stroke-width="2" fill="none" stroke-dasharray="2 6" stroke-linecap="round" opacity=".8"/><path d="M232 118 l40 -14 -14 40 -8 -16 -18 -10z" fill="#0BBF8C"/></svg>""",
"manufacturer-case": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><circle cx="250" cy="142" r="70" fill="#2B5CFF" opacity=".22"/><rect x="54" y="118" width="26" height="40" rx="4" fill="#3D6BFF" opacity=".7"/><rect x="90" y="98" width="26" height="60" rx="4" fill="#3D6BFF" opacity=".82"/><rect x="126" y="74" width="26" height="84" rx="4" fill="#4E7BFF"/><rect x="162" y="52" width="26" height="106" rx="4" fill="#6E93FF"/><rect x="198" y="34" width="26" height="124" rx="4" fill="#0BBF8C"/><path d="M60 110 L103 90 L139 66 L175 46 L211 28" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/><circle cx="211" cy="28" r="6" fill="#fff"/><path d="M232 44 l14 -16 14 16" stroke="#0BBF8C" stroke-width="3.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/><text x="246" y="152" font-size="13" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif" opacity=".9">3M</text></svg>""",
}
