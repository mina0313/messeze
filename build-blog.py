...
"indexed-not-cited": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="cv8a" cx="50%" cy="50%" r="50%"><stop offset="0" stop-color="#7CA0FF" stop-opacity=".5"/><stop offset="1" stop-color="#7CA0FF" stop-opacity="0"/></radialGradient><filter id="cv8s" x="-40%" y="-40%" width="180%" height="180%"><feDropShadow dx="0" dy="7" stdDeviation="9" flood-color="#06122b" flood-opacity=".38"/></filter></defs><circle cx="256" cy="32" r="86" fill="url(#cv8a)"/><circle cx="44" cy="162" r="56" fill="url(#cv8a)"/><path d="M130 90 h52" stroke="#94A0B4" stroke-width="2.4" stroke-dasharray="3 6" fill="none" stroke-linecap="round"/><path d="M180 85 l7 5 -7 5" stroke="#94A0B4" stroke-width="2.4" fill="none" stroke-linecap="round" stroke-linejoin="round"/><g filter="url(#cv8s)"><rect x="24" y="50" width="100" height="80" rx="18" fill="#fff"/></g><g transform="translate(58.15,76.15) scale(0.66)"><path fill="#4285F4" d="M45.12 24.5c0-1.56-.14-3.06-.4-4.5H24v8.51h11.84c-.51 2.75-2.06 5.08-4.39 6.64v5.52h7.11c4.16-3.83 6.56-9.47 6.56-16.17z"/><path fill="#34A853" d="M24 46c5.94 0 10.92-1.97 14.56-5.33l-7.11-5.52c-1.97 1.32-4.49 2.1-7.45 2.1-5.73 0-10.58-3.87-12.31-9.07H4.34v5.7C7.96 41.07 15.4 46 24 46z"/><path fill="#FBBC05" d="M11.69 28.18C11.25 26.86 11 25.45 11 24s.25-2.86.69-4.18v-5.7H4.34C2.85 17.09 2 20.45 2 24s.85 6.91 2.34 9.88l7.35-5.7z"/><path fill="#EA4335" d="M24 9.75c3.23 0 6.13 1.11 8.41 3.29l6.31-6.31C34.91 3.18 29.93 1 24 1 15.4 1 7.96 5.93 4.34 13.12l7.35 5.7c1.73-5.2 6.58-9.07 12.31-9.07z"/></g><circle cx="114" cy="64" r="11" fill="#0BBF8C"/><path d="M109.4 64l3 3 6.2-6.6" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/><g filter="url(#cv8s)"><rect x="196" y="50" width="100" height="80" rx="18" fill="#fff"/></g><g transform="translate(229.8,73.8) scale(1.35)" fill="#0A1930"><path d="M22.28 9.82a5.98 5.98 0 0 0-.52-4.91 6.05 6.05 0 0 0-6.51-2.9A6.07 6.07 0 0 0 4.98 4.18a5.98 5.98 0 0 0-3.998 2.9 6.05 6.05 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 22.05a4.5 4.5 0 0 1-6.14-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071.006zM18.44 11.6l-5.83-3.383L14.63 7.05a.076.076 0 0 1 .071-.006l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.415-.662zm2.01-3.023l-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L8.921 9.08V6.75a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zM7.82 12.74l-2.02-1.164a.08.08 0 0 1-.038-.057V5.936a4.5 4.5 0 0 1 7.375-3.453l-.142.08L8.216 5.32a.795.795 0 0 0-.393.681zm1.097-2.365l2.602-1.5 2.607 1.5v3l-2.602 1.5-2.607-1.5z"/></g><circle cx="286" cy="62" r="11" fill="#fff" stroke="#E2574C" stroke-width="2.2"/><text x="286" y="66.5" font-size="13" fill="#E2574C" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">?</text></svg>""",
