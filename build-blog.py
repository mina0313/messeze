...
"indexed-not-cited": """<svg class="cover" viewBox="0 0 320 180" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="cv8a" cx="50%" cy="50%" r="50%"><stop offset="0" stop-color="#7CA0FF" stop-opacity=".5"/><stop offset="1" stop-color="#7CA0FF" stop-opacity="0"/></radialGradient><linearGradient id="cv8c" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#6E93FF"/><stop offset="1" stop-color="#1E46D9"/></linearGradient><filter id="cv8s" x="-40%" y="-40%" width="180%" height="180%"><feDropShadow dx="0" dy="7" stdDeviation="9" flood-color="#06122b" flood-opacity=".4"/></filter></defs><circle cx="256" cy="34" r="88" fill="url(#cv8a)"/><circle cx="40" cy="162" r="58" fill="url(#cv8a)"/><g filter="url(#cv8s)"><rect x="24" y="44" width="106" height="92" rx="14" fill="#fff"/></g><circle cx="43" cy="63" r="7" fill="#0BBF8C"/><path d="M39.6 63l2.4 2.4 4.4-4.6" stroke="#fff" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/><rect x="56" y="59" width="58" height="7" rx="3.5" fill="#0A1930"/><rect x="40" y="80" width="74" height="6" rx="3" fill="#DCE6F7"/><rect x="40" y="94" width="74" height="6" rx="3" fill="#DCE6F7"/><rect x="40" y="108" width="48" height="6" rx="3" fill="#DCE6F7"/><path d="M138 92 h36" stroke="#94A0B4" stroke-width="2.5" stroke-dasharray="3 6" fill="none" stroke-linecap="round"/><circle cx="156" cy="72" r="12" fill="#fff" stroke="#E2574C" stroke-width="2.4"/><text x="156" y="76.5" font-size="14" fill="#E2574C" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">?</text><g filter="url(#cv8s)"><rect x="182" y="52" width="112" height="80" rx="16" fill="url(#cv8c)"/></g><rect x="198" y="68" width="26" height="26" rx="9" fill="#fff" opacity=".22"/><text x="211" y="85" font-size="11" fill="#fff" text-anchor="middle" font-weight="800" font-family="Poppins,sans-serif">AI</text><rect x="232" y="71" width="50" height="7" rx="3.5" fill="#fff" opacity=".9"/><rect x="198" y="104" width="84" height="6" rx="3" fill="#fff" opacity=".5"/><rect x="198" y="116" width="60" height="6" rx="3" fill="#fff" opacity=".38"/></svg>""",
