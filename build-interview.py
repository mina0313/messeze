...
c(slug="parts", tag="정밀부품 제조", com="○○정밀", who="김○○ 대표", photo=U.format("1622902046580-2b47f47f5471"),
  ...
  period="16주", plan="기업형",
  metrics=[("0→7","AI 인용 질문 수","핵심 질문 9개 중"),("34%","AI 답변 등장률","4개 엔진 평균"),("14건","축적 콘텐츠·기사","언론 6건 포함"),("2배","월 신규 문의","시작 전 대비")],
  ...
  weeks=[("시작",0),("4주",8),("8주",18),("12주",26),("16주",34)],
...
c(slug="export", tag="수출기업", com="○○인더스트리", who="이○○ 마케팅팀장", photo=U.format("1548142813-c348350df52b"),
  ...
  metrics=[("3배","해외 바이어 문의","시작 전 대비"),("0→11","AI 인용 질문 수","한·영 질문 14개 중"),("22건","축적 콘텐츠·기사","현지어 보도 8건"),("41%","AI 답변 등장률","4개 엔진 평균")],
  ...
  weeks=[("시작",0),("6주",10),("12주",22),("18주",33),("24주",41)],
...
c(slug="material", tag="산업소재", com="○○소재", who="박○○ 대표", photo=U.format("1611403119860-57c4937ef987"),
  ...
  period="16주", plan="기업형",
  metrics=[("0→6","AI 인용 질문 수","핵심 질문 8개 중"),("29%","AI 답변 등장률","4개 엔진 평균"),("12건","축적 콘텐츠·기사","기술 칼럼 8편"),("2배","기술 문의","시작 전 대비")],
  ...
  weeks=[("시작",0),("4주",6),("8주",15),("12주",23),("16주",29)],
...
c(slug="equip", tag="자동화 설비", com="○○오토메이션", who="최○○ 이사", photo=U.format("1534528741775-53994a69daeb"),
  ...
  period="20주", plan="기업형",
  metrics=[("0→8","AI 인용 질문 수","핵심 질문 10개 중"),("31%","AI 답변 등장률","4개 엔진 평균"),("16건","축적 콘텐츠·기사","도입 사례 6편"),("1.8배","상담 요청","시작 전 대비")],
  ...
  weeks=[("시작",0),("5주",9),("10주",19),("15주",26),("20주",31)],
...
c(slug="clinic", tag="병원·의원", com="○○치과의원", who="정○○ 원장", photo=P.format("8376281","8376281"),
  ...
  period="12주", plan="소상공인형",
  metrics=[("0→5","AI 인용 질문 수","지역 질문 7개 중"),("38%","AI 답변 등장률","지역 질문 기준"),("11건","축적 콘텐츠","진료 가이드 칼럼"),("1.6배","신규 예약 문의","시작 전 대비")],
  ...
  weeks=[("시작",0),("3주",11),("6주",22),("9주",31),("12주",38)],
...
c(slug="b2b", tag="B2B 솔루션", com="○○시스템", who="한○○ 영업이사", photo=P.format("17049771","17049771"),
  ...
  period="16주", plan="기업형",
  metrics=[("0→7","AI 인용 질문 수","핵심 질문 9개 중"),("33%","AI 답변 등장률","4개 엔진 평균"),("15건","축적 콘텐츠·기사","비교 가이드 5편"),("2.2배","인바운드 문의","시작 전 대비")],
  ...
  weeks=[("시작",0),("4주",7),("8주",17),("12주",26),("16주",33)],
...
c(slug="food", tag="식품 중소기업", com="○○식품", who="오○○ 대표", photo=P.format("7964223","7964223"),
  ...
  period="16주", plan="소상공인형",
  metrics=[("0→6","AI 인용 질문 수","핵심 질문 8개 중"),("27%","AI 답변 등장률","4개 엔진 평균"),("13건","축적 콘텐츠·기사","HACCP 스토리 포함"),("1.7배","납품 문의","시작 전 대비")],
  ...
  weeks=[("시작",0),("4주",5),("8주",13),("12주",21),("16주",27)],
...
c(slug="franchise", tag="프랜차이즈 외식", com="○○외식", who="강○○ 대표", photo=P.format("3760605","3760605"),
  ...
  period="12주", plan="소상공인형",
  metrics=[("0→5","AI 인용 질문 수","창업 질문 7개 중"),("30%","AI 답변 등장률","4개 엔진 평균"),("10건","축적 콘텐츠","창업 가이드 칼럼"),("1.9배","가맹 상담 신청","시작 전 대비")],
  ...
  weeks=[("시작",0),("3주",8),("6주",16),("9주",24),("12주",30)],
